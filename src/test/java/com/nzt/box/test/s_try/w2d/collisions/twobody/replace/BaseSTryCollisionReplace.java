...
@TestScreen(group = "2D.collision.replace")
abstract class BaseSTryCollisionReplace<S1 extends BodyShape, S2 extends BodyShape> extends BaseSTry2Body<S1, S2> {
    public BaseSTryCollisionReplace(FastTesterMain main) {
        super(main, BodyType.Dynamic, BodyType.Dynamic);
        infoMsg("Press F for change body control");
        infoMsg("Press R for reset order");
    }
