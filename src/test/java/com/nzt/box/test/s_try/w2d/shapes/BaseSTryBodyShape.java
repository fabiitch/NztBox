...
@TestScreen(group = "2D.BodyShape")
public abstract class BaseSTryBodyShape<B extends BodyShape> extends BaseBox2DSTry {
    protected Body body;
    protected B bodyShape;
    protected Vector2 tmp = new Vector2();

    public BaseSTryBodyShape(FastTesterMain main) {
        super(main);
        ...
        world.addBody(body);
        addListener();
        infoMsg("Click for change order");
