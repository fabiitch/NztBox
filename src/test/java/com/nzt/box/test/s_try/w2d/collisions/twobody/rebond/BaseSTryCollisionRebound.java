...
@TestScreen(group = "2D.collision.rebound")
abstract class BaseSTryCollisionRebound<S1 extends BodyShape, S2 extends BodyShape> extends BaseSTry2Body<S1, S2> {

    private Vector2 target = new Vector2();
    boolean drawContactInfo = false;

    public BaseSTryCollisionRebound(FastTesterMain main) {
        super(main, BodyType.Dynamic, BodyType.Static);
        infoMsg("Press F for change shape moving");
        infoMsg("Right Click for change pos order");
