...
import com.nzt.box.test.screens.w2d.physx.balls.collisions.STBallsTwoDirCollision;
...
public class NztBoxTestStarter {
    private static final Class screenTestClass = STBallsTwoDirCollision.class;
